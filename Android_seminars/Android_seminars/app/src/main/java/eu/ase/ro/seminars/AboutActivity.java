...
import static eu.ase.ro.seminars.utils.Constants.KEY_ACTIVITY_TO_FRAGMENT;
import static eu.ase.ro.seminars.utils.Constants.KEY_ACTIVITY_TO_FRAGMENT_INT;
import static eu.ase.ro.seminars.utils.Constants.RATING_BAR_ABOUT_VALUE;
import static eu.ase.ro.seminars.utils.Constants.SHARED_PREFERENCES_NAME;
...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(USER_INFO_KEY)) {
            ...
            //its parameter is the key that the object was saved at through the call of putExtra() method
        ...
        btnFragment2.setOnClickListener(view -> openFragment(fragment2));
