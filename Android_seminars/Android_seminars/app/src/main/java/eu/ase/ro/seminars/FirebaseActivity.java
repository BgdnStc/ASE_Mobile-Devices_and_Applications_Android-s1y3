...
import eu.ase.ro.seminars.firebase.FirebaseController;
...
public class FirebaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvFirebase.setOnItemLongClickListener((adapterView, view, position, l) -> {
            Movie movie1 = movieList.get(position);
            firebaseController.removeMovie(movie1);
            MovieAdapter adapter = new MovieAdapter(getApplicationContext(), R.layout.lv_movies_row, movieList, getLayoutInflater());
    ...
    private ValueEventListener loadMovies() {
        return new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MovieAdapter movieAdapter = new MovieAdapter(getApplicationContext(), R.layout.lv_movies_row, movieList, getLayoutInflater());
